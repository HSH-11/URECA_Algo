...
public class Samsung_고대문명유적탐사 {
	...
	/**
	 * 제거된 칸(0)을 새로운 숫자로 채움 왼쪽에서 오른쪽, 아래쪽부터 위로 올라가며 채움 채워지는 순서에 맞게 반복문을 적절하게 구성해야함
	 */
	static void fill() {
		for (int c = 0; c < SIZE; c++) {
...
/**
 * 회전 정보를 저장하고 비교하기 위한 클래스 점수가 높은 순, 각도가 작은 순, 열이 작은 순, 행이 작은 순으로 정렬
 */
